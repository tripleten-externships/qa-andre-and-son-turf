...
export class PlantFoodPage{ 
    ...
    constructor(page: Page){
        ...
        this.pfPHGMLearnMoreButton=page.locator('(//span[normalize-space()="Learn More"])[2]')
        //getByRole('link', { name: 'Learn More', exact: true }).nth(1);
        ...
        this.plantFood0025Title=page.getByText('Plant Food 0-0-25');
        //getByRole('heading', {name: '0-0-25'});
        ...
        this.plantFood101010Title=page.getByText('Plant Food 10-10-10');
        //getByRole('heading', {name: '10-10-10'});
        ...
        this.plantFood10340Title=page.getByText('Plant Food 10-34-0');
        //getByRole('heading', {name: '10-34-0'});
        ...
        this.plantFood1046Title=page.getByText('Plant Food 10-4-6');
        //getByRole('heading', {name: '10-4-6'});
        ...
        this.plantFood12012Title=page.getByText('Plant Food 12-0-12');
        //getByRole('heading', {name: '12-0-12'});
        ...
        this.plantFood12312Title=page.getByText('Plant Food 12-3-12');
        //getByRole('heading', {name: '12-3-12'});
        ...
        this.plantFood1628Title=page.getByText('Plant Food 16-2-8');
        //getByRole('heading', {name: '16-2-8'});
        ...
        this.plantFood1645Title=page.getByText('Plant Food 16-4-5');
        //getByRole('heading', {name: '16-4-5'});
        ...
        this.plantFood1833Title=page.getByText('Plant Food 18-3-3');
        //getByRole('heading', {name: '18-3-3'});
        ...
        this.plantFood1834SuperTitle=page.getByText('Plant Food 18-3-4 Super');
        //getByRole('heading', {name: '18-3-4 Super'});
        ...
        this.plantFood2000Title=page.getByText('Plant Food 20-0-0');
        //getByRole('heading', {name: '20-0-0'});
        ...
        this.plantFood2003LawnTitle=page.getByText('Plant Food 20-0-3 Lawn');
        //getByRole('heading', {name: '20-0-3 Lawn'});
        ...
        this.plantFood2800Title=page.getByText('Plant Food 28-0-0');
        //getByRole('heading', {name: '28-0-0'});
        ...
        this.plantFood2900Title=page.getByText('Plant Food 29-0-0');
        //getByRole('heading', {name: '29-0-0'});
        ...
        this.plantFood3000UANTitle=page.getByText('Plant Food 30-0-0 UAN');
        //getByRole('heading', {name: '30-0-0 UAN'});
        ...
        this.plantFood5IronTitle=page.getByText('Plant Food 5% Iron');
        //getByRole('heading', {name: '5% Iron'});
        ...
        this.plantFood700SulfurTitle=page.getByText('Plant Food 7-0-0 Sulfur');
        //getByRole('heading', {name: '7-0-0 Sulfur'});
        ...
        this.plantFood707Title=page.getByText('Plant Food 7-0-7');
        //getByRole('heading', {name: '7-0-7'});
        ...
        this.plantFoodAdamsEarthTitle=page.getByText('Plant Food Adam\'s Earth');
        //getByRole('heading', {name: "Adam's Earth"});
        ...
        this.plantFoodAmmoniumThiosulfateTitle=page.getByText('Plant Food Ammonium');
        //getByRole('heading', {name: 'Ammonium Thiosulfate'});
        ...
        this.plantFoodBlackstrapMolassTitle=page.getByText('Plant Food Blackstrap Molass');
        //getByRole('heading', {name: 'Blackstrap Molass'});
        ...
        this.plantFoodBoron10Title=page.getByText('Plant Food Boron 10%');
        //getByRole('heading', {name: 'Boron 10'});
        ...
        this.plantFoodCalciumNitrateTitle=page.getByText('Plant Food Calcium Nitrate');
        //getByRole('heading', {name: 'Calcium Nitrate'});
        ...
        this.plantFoodHandPumpTitle=page.getByText('Plant Food Hand Pump');
        //getByRole('heading', {name: 'Hand Pump'});
        ...
        this.plantFoodHumicAcid70Title=page.getByText('Plant Food Humic Acid 70%');
        //getByRole('heading', {name: 'Humic Acid 70'});
        ...
        this.plantFoodHydrationAPLUSTitle=page.getByText('Plant Food Hydration A-PLUS')
        //getByRole('heading', {name: 'Hydration A-PLUS'});
        ...
        this.plantFoodImpulseTitle=page.getByText('Plant Food Impulse');
        //getByRole('heading', {name: 'Impulse'});
        ...
        this.plantFoodKCSPlus0018Title=page.getByText('Plant Food KCS Plus 0-0-18')
        //getByRole('heading', {name: 'KCS Plus 0-0-18'});
        ...
        this.plantFoodKelpIronTitle=page.getByText('Plant Food Kelp Iron');
        //getByRole('heading', {name: 'Kelp Iron'});
